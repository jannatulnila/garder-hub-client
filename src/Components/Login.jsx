...
const Login = () => {
    ...
    const { signIn, GoogleSignIn, emailRef } = use(AuthContext);
    ...
    const handleGoogleSignIn = (e) => {
        ...
        GoogleSignIn()
            .then((result) => {
                ...
                navigate(`${location.state?.from?.pathname || "/"}`); // Go to previous page or home
            })
            .catch((error) => {
                console.log(error);
            })
                ...
                <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                    ...
                    <form onSubmit={handleLogin} className="card-body">
                        <fieldset className="fieldset">
                            ...
                            <p className='font-semibold text-center pt-5'>Don't have an account?<Link className='text-primary underline' to="/register">Register</Link> </p>
                        </fieldset>
                    </form>
